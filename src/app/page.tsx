        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          ...
          <div className={`w-full order-1 md:order-none relative transition-all duration-300 ease-out ${routesPanelCollapsed ? "md:flex-1" : "md:w-1/2 md:shrink-0"}`}>
            ...
            <button
              ...
              className={`hidden md:flex h-10 w-8 items-center justify-center rounded-full border border-outline-variant/40 bg-surface-container-lowest text-primary shadow-card hover:bg-surface-container transition-all ${routesPanelCollapsed ? `fixed top-20 ${sidebarCollapsed ? "left-16" : "left-60"} z-50` : "absolute top-6 left-0 z-30 -translate-x-1/2"}`}
