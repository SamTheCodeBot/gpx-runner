        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          ...
          <div className={`w-full order-1 md:order-none relative transition-all duration-300 ease-out ${routesPanelCollapsed ? "md:flex-1" : "md:w-1/2 md:shrink-0"}`}>
            ...
            <button
              ...
              className={`hidden md:flex absolute z-30 h-10 items-center justify-center rounded-full border border-outline-variant/40 bg-surface-container-lowest text-primary shadow-card hover:bg-surface-container transition-all ${routesPanelCollapsed ? "top-6 left-16 w-10" : "top-6 left-0 w-8 -translate-x-1/2"}`}
